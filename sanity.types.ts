...
// Query: coalesce(    *[_type == "board" && skuCode == $sku && language == $locale && !(_id in path("drafts.**"))][0],    *[_type == "board" && skuCode == $sku && !(_id in path("drafts.**"))][0]  ) {    "name": name,    mainImage,    "aspectRatio": mainImage.asset->metadata.dimensions.aspectRatio  }
