...
import SectionFullMedia from '@/components/sections/full-media/SectionFullMedia'
import SectionBigQuote from '@/components/sections/big-quote/SectionBigQuote'
import SectionMediaLine from '@/components/sections/media-line/SectionMediaLine'
import SectionFeatures from '@/components/sections/features/SectionFeatures'
import SectionOutline from '@/components/sections/outline/SectionOutline'
import SectionFixedImage from '@/components/sections/fixed-image/SectionFixedImage'
import SectionSpecs from '@/components/sections/specs/SectionSpecs'
import CartPreview from '@/components/commerce/cart/CartPreview'
