...
export default async function TheftPage() {
  const claims = await getClaims('theft')
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Vol</h1>
        <p className="text-muted-foreground text-sm">Boards déclarées volées — suivi et traitement.</p>
      </div>
